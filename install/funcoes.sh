...
func_install_A2B  () { 
				...
				cd /usr/src/billing
				wget --no-check-certificate https://raw.githubusercontent.com/eluizbr/VOXIPBX/$BRANCH/install/a2billing.tgz
				...
				cd /usr/src/
				wget --no-check-certificate https://raw.githubusercontent.com/eluizbr/VOXIPBX/$BRANCH/install/a2billing.conf
				mv a2billing.conf /usr/src/billing/
				
				# Instalando base A2B
				cd /var/www/ipbx/install
				echo "create database billing" | mysql -u root -ptofalando2014
				wget --no-check-certificate https://raw.githubusercontent.com/eluizbr/VOXIPBX/$BRANCH/install/billing.sql
